<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GiangVien.aspx.cs" Inherits="QLDD.GiangVien1" %>
            ...
            <div class="content">
                ...
                <table style="width: 60%;">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox id="txtMagv" runat="server" class="form-control" Width="255px"></asp:TextBox>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox id="txtTrinhdo" runat="server" class="form-control" Width="255px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style1">Chức vụ</td>
                        <td>
                            <asp:TextBox id="txtChucvu" runat="server" class="form-control" Width="255px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style1">Chuyên môn</td>
                        <td>
                            <asp:TextBox id="txtChuyenmon" runat="server" class="form-control" Width="255px"></asp:TextBox>
                        </td>
                    </tr>
